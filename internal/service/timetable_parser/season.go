...
func mapTimetableToSeason(season timetable_parser_config.Season, routes map[timetable.TrainId]timetable.DetailedTimetable) timetable.Season {
	...
	return timetable.Season{
		...
		NoTrainsWarning: timetable.Warning{
			Be: season.NoTrainsWarning.Be,
			De: season.NoTrainsWarning.De,
			En: season.NoTrainsWarning.En,
			Hr: season.NoTrainsWarning.Hr,
			Ru: season.NoTrainsWarning.Ru,
			Sk: season.NoTrainsWarning.Sk,
			Sr: season.NoTrainsWarning.Sr,
			Tr: season.NoTrainsWarning.Tr,
			Uk: season.NoTrainsWarning.Uk,
		},
		UpdateButtonAlertText: timetable.Warning{
			Be: season.UpdateButtonAlertText.Be,
			De: season.UpdateButtonAlertText.De,
			En: season.UpdateButtonAlertText.En,
			Hr: season.UpdateButtonAlertText.Hr,
			Ru: season.UpdateButtonAlertText.Ru,
			Sk: season.UpdateButtonAlertText.Sk,
			Sr: season.UpdateButtonAlertText.Sr,
			Tr: season.UpdateButtonAlertText.Tr,
			Uk: season.UpdateButtonAlertText.Uk,
		},
