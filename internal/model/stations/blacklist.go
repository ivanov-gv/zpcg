...
var BlackListedStations = []struct {
...

	{
		...
		LanguageTagToCustomErrorMessageMap: map[language.Tag]string{
			...
			message_render.Belarusian: "У Будве няма жд-станцый",
	...
	},
	{
		...
		LanguageTagToCustomErrorMessageMap: map[language.Tag]string{
			...
			message_render.Belarusian: "У Тівате няма жд-станцый",
	...
	},
	{
		...
		LanguageTagToCustomErrorMessageMap: map[language.Tag]string{
			...
			message_render.Belarusian: "У Котары няма жд-станцый",
	...
	},
	{
		...
		LanguageTagToCustomErrorMessageMap: map[language.Tag]string{
			...
			message_render.Belarusian: "У Цетыне няма жд-станцый",
	...
	},
	{
		...
		LanguageTagToCustomErrorMessageMap: map[language.Tag]string{
			...
			message_render.Belarusian: "У Перасце няма жд-станцый",
	...
	},
	{
		...
		LanguageTagToCustomErrorMessageMap: map[language.Tag]string{
			...
			message_render.Belarusian: "У Дурміторы няма жд-станцый",
	...
	},
	{
		...
		LanguageTagToCustomErrorMessageMap: map[language.Tag]string{
			...
			message_render.Belarusian: "У Петроваце няма жд-станцый",
	...
	},
	{
		...
		LanguageTagToCustomErrorMessageMap: map[language.Tag]string{
			...
			message_render.Belarusian: "У Ульціне няма жд-станцый",
	...
	},
	{
		...
		LanguageTagToCustomErrorMessageMap: map[language.Tag]string{
			...
			message_render.Belarusian: "У Святога Стэфана няма жд-станцый",
	...
	},
	{
		...
		LanguageTagToCustomErrorMessageMap: map[language.Tag]string{
			...
			message_render.Belarusian: "У Бечыцы няма жд-станцый",
	...
	},
	{
		...
		LanguageTagToCustomErrorMessageMap: map[language.Tag]string{
			...
			message_render.Belarusian: "У Герцага-Новым няма жд-станцый",
	...
	},
	{
		...
		LanguageTagToCustomErrorMessageMap: map[language.Tag]string{
			...
			message_render.Belarusian: "У Шаўнік няма жд-станцый",
	...
	},
	{
		...
		LanguageTagToCustomErrorMessageMap: map[language.Tag]string{
			...
			message_render.Belarusian: "У Жабляку няма жд-станцый",
	...
	},
	{
		...
		LanguageTagToCustomErrorMessageMap: map[language.Tag]string{
			...
			message_render.Belarusian: "З Чарнагорыі няма жадзіловага сувязі з Албаніяй",
	...
	},
	{
		...
		LanguageTagToCustomErrorMessageMap: map[language.Tag]string{
			...
			message_render.Belarusian: "З Чарнагорыі няма жадзіловага сувязі з Боснія і Герцагавіна",
