...
The original timetable is available at: - https://zpcg.me/search

# Requirements

1. Ensure it's straightforward and user-friendly
    1. Provides a menu with all available commands
    2. Has a start message with a brief and complete description of how to get the timetable
    3. Returns the requested timetable even if the user made a typo
    4. In case of an error returns a message with a detailed description of how to resolve the issue
...
{update button} {reverse route button}
```
...
The bot uses a custom path-finding algorithm. It does not use Dijkstra to solve the problem.
...
2. Request is handled, route is generated, and reply message is sent. It takes about 200ms.
...
This project might be improved in several ways to meet the requirements listed above.
...
port this solution to other platforms to reach the audience.
...
because
there is a person behind the scenes who is answering all the questions. I think it is a good idea to provide the same
service
