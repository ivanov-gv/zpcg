...
var Timetable = timetable.ExportFormat{
	StationIdToTrainIdSet: map[timetable.StationId]timetable.TrainIdSet{
		...
		57: timetable.TrainIdSet{1130: struct{}{}, 1131: struct{}{}},
		60: timetable.TrainIdSet{1130: struct{}{}, 1131: struct{}{}},
		66: timetable.TrainIdSet{1130: struct{}{}, 1131: struct{}{}},
		70: timetable.TrainIdSet{1130: struct{}{}, 1131: struct{}{}},
		71: timetable.TrainIdSet{1130: struct{}{}, 1131: struct{}{}},
	},
	TrainIdToStationMap: map[timetable.TrainId]timetable.StationIdToStationMap{
		432: timetable.StationIdToStationMap{
			...
			7: timetable.Stop{
				...
				Departure: time.Date(0, time.January, 2, 0, 6, 0, 0, time.UTC),
			},
			8: timetable.Stop{
				Id:        8,
				Arrival:   time.Date(0, time.January, 2, 0, 54, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 2, 0, 59, 0, 0, time.UTC),
			},
			9: timetable.Stop{
				Id:        9,
				Arrival:   time.Date(0, time.January, 2, 1, 4, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 2, 1, 5, 0, 0, time.UTC),
			},
			10: timetable.Stop{
				Id:        10,
				Arrival:   time.Date(0, time.January, 2, 2, 10, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 2, 2, 11, 0, 0, time.UTC),
			},
			11: timetable.Stop{
				Id:        11,
				Arrival:   time.Date(0, time.January, 2, 3, 56, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 2, 4, 6, 0, 0, time.UTC),
			},
			12: timetable.Stop{
				Id:        12,
			...
			13: timetable.Stop{
				Id:        13,
				Arrival:   time.Date(0, time.January, 2, 4, 56, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 2, 4, 56, 0, 0, time.UTC),
			},
			14: timetable.Stop{
				Id:        14,
				Arrival:   time.Date(0, time.January, 2, 5, 51, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 2, 5, 51, 0, 0, time.UTC),
			},
			15: timetable.Stop{
				Id:        15,
				Arrival:   time.Date(0, time.January, 2, 6, 11, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 2, 6, 13, 0, 0, time.UTC),
			},
			16: timetable.Stop{
				Id:        16,
				Arrival:   time.Date(0, time.January, 2, 6, 19, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 2, 6, 20, 0, 0, time.UTC),
			},
			17: timetable.Stop{
				Id:        17,
				Arrival:   time.Date(0, time.January, 2, 7, 0, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 2, 7, 1, 0, 0, time.UTC),
			},
			18: timetable.Stop{
				Id:        18,
				Arrival:   time.Date(0, time.January, 2, 7, 9, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 2, 7, 19, 0, 0, time.UTC),
			},
			19: timetable.Stop{
				Id:        19,
				Arrival:   time.Date(0, time.January, 2, 7, 26, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 2, 7, 26, 0, 0, time.UTC),
			},
		},
		433: timetable.StationIdToStationMap{
			...
			2: timetable.Stop{
				Id:        2,
				Arrival:   time.Date(0, time.January, 2, 6, 32, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 2, 6, 40, 0, 0, time.UTC),
			},
			3: timetable.Stop{
				Id:        3,
				Arrival:   time.Date(0, time.January, 2, 5, 59, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 2, 6, 4, 0, 0, time.UTC),
			},
			4: timetable.Stop{
				Id:        4,
				Arrival:   time.Date(0, time.January, 2, 5, 40, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 2, 5, 48, 0, 0, time.UTC),
			},
			5: timetable.Stop{
				Id:        5,
				Arrival:   time.Date(0, time.January, 2, 4, 23, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 2, 4, 24, 0, 0, time.UTC),
			},
			6: timetable.Stop{
				Id:        6,
				Arrival:   time.Date(0, time.January, 2, 4, 5, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 2, 4, 6, 0, 0, time.UTC),
			},
			7: timetable.Stop{
				Id:        7,
				Arrival:   time.Date(0, time.January, 2, 2, 57, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 2, 3, 40, 0, 0, time.UTC),
			},
			8: timetable.Stop{
				Id:        8,
				Arrival:   time.Date(0, time.January, 2, 2, 4, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 2, 2, 14, 0, 0, time.UTC),
			},
			9: timetable.Stop{
				Id:        9,
			...
			10: timetable.Stop{
				Id:        10,
				Arrival:   time.Date(0, time.January, 2, 0, 56, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 2, 0, 57, 0, 0, time.UTC),
			},
			11: timetable.Stop{
				Id:        11,
				Arrival:   time.Date(0, time.January, 1, 23, 2, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 1, 23, 12, 0, 0, time.UTC),
			},
			12: timetable.Stop{
				Id:        12,
				Arrival:   time.Date(0, time.January, 1, 22, 40, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 1, 22, 42, 0, 0, time.UTC),
			},
			13: timetable.Stop{
				Id:        13,
				Arrival:   time.Date(0, time.January, 1, 22, 11, 0, 0, time.UTC),
			...
			16: timetable.Stop{
				Id:        16,
				Arrival:   time.Date(0, time.January, 1, 20, 50, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 1, 20, 51, 0, 0, time.UTC),
			},
			17: timetable.Stop{
				Id:        17,
			...
			19: timetable.Stop{
				Id:        19,
				Arrival:   time.Date(0, time.January, 1, 19, 40, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 1, 19, 40, 0, 0, time.UTC),
			},
		},
		1130: timetable.StationIdToStationMap{
			...
			8: timetable.Stop{
				...
				Departure: time.Date(0, time.January, 1, 13, 58, 0, 0, time.UTC),
			},
			9: timetable.Stop{
				Id:        9,
				Arrival:   time.Date(0, time.January, 1, 14, 3, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 1, 14, 4, 0, 0, time.UTC),
			},
			10: timetable.Stop{
				Id:        10,
				Arrival:   time.Date(0, time.January, 1, 14, 54, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 1, 14, 58, 0, 0, time.UTC),
			},
			11: timetable.Stop{
				Id:        11,
			...
			57: timetable.Stop{
				Id:        57,
				Arrival:   time.Date(0, time.January, 2, 21, 1, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 2, 21, 1, 0, 0, time.UTC),
			},
			60: timetable.Stop{
				Id:        60,
				Arrival:   time.Date(0, time.January, 2, 20, 23, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 2, 20, 24, 0, 0, time.UTC),
			},
			66: timetable.Stop{
				Id:        66,
			...
			70: timetable.Stop{
				Id:        70,
				Arrival:   time.Date(0, time.January, 2, 20, 45, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 2, 20, 46, 0, 0, time.UTC),
			},
			71: timetable.Stop{
				Id:        71,
				Arrival:   time.Date(0, time.January, 2, 20, 40, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 2, 20, 41, 0, 0, time.UTC),
			},
		},
		1131: timetable.StationIdToStationMap{
			...
			8: timetable.Stop{
				Id:        8,
				Arrival:   time.Date(0, time.January, 1, 16, 7, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 1, 16, 10, 0, 0, time.UTC),
			},
			9: timetable.Stop{
				Id:        9,
			...
			10: timetable.Stop{
				Id:        10,
				Arrival:   time.Date(0, time.January, 1, 14, 57, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 1, 14, 57, 0, 0, time.UTC),
			},
			11: timetable.Stop{
				Id:        11,
				Arrival:   time.Date(0, time.January, 1, 12, 57, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 1, 13, 5, 0, 0, time.UTC),
			},
			12: timetable.Stop{
				Id:        12,
				Arrival:   time.Date(0, time.January, 1, 12, 37, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 1, 12, 37, 0, 0, time.UTC),
			},
			13: timetable.Stop{
				Id:        13,
				Arrival:   time.Date(0, time.January, 1, 12, 9, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 1, 12, 9, 0, 0, time.UTC),
			},
			14: timetable.Stop{
				Id:        14,
			...
			57: timetable.Stop{
				...
				Departure: time.Date(0, time.January, 1, 8, 58, 0, 0, time.UTC),
			},
			60: timetable.Stop{
				Id:        60,
				Arrival:   time.Date(0, time.January, 1, 9, 36, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 1, 9, 37, 0, 0, time.UTC),
			},
			66: timetable.Stop{
				Id:        66,
				Arrival:   time.Date(0, time.January, 1, 13, 39, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 1, 13, 39, 0, 0, time.UTC),
			},
			70: timetable.Stop{
				Id:        70,
			...
			71: timetable.Stop{
				...
				Departure: time.Date(0, time.January, 1, 9, 18, 0, 0, time.UTC),
			},
		},
		...
		6104: timetable.StationIdToStationMap{
			1: timetable.Stop{
				...
				Departure: time.Date(0, time.January, 1, 18, 5, 0, 0, time.UTC),
			},
			2: timetable.Stop{
				Id:        2,
			...
			3: timetable.Stop{
				Id:        3,
				Arrival:   time.Date(0, time.January, 1, 18, 53, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 1, 18, 54, 0, 0, time.UTC),
			},
			4: timetable.Stop{
				Id:        4,
			...
			7: timetable.Stop{
				Id:        7,
				Arrival:   time.Date(0, time.January, 1, 21, 37, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 1, 21, 37, 0, 0, time.UTC),
			},
			20: timetable.Stop{
				Id:        20,
				Arrival:   time.Date(0, time.January, 1, 18, 8, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 1, 18, 9, 0, 0, time.UTC),
			},
			21: timetable.Stop{
				Id:        21,
				Arrival:   time.Date(0, time.January, 1, 18, 28, 0, 0, time.UTC),
			...
			22: timetable.Stop{
				...
				Departure: time.Date(0, time.January, 1, 18, 34, 0, 0, time.UTC),
			},
			23: timetable.Stop{
				Id:        23,
				Arrival:   time.Date(0, time.January, 1, 18, 39, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 1, 18, 40, 0, 0, time.UTC),
			},
			24: timetable.Stop{
				Id:        24,
				Arrival:   time.Date(0, time.January, 1, 18, 43, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 1, 18, 44, 0, 0, time.UTC),
			},
			25: timetable.Stop{
				Id:        25,
				Arrival:   time.Date(0, time.January, 1, 18, 49, 0, 0, time.UTC),
			...
			26: timetable.Stop{
				...
				Departure: time.Date(0, time.January, 1, 18, 58, 0, 0, time.UTC),
			},
			27: timetable.Stop{
				Id:        27,
				Arrival:   time.Date(0, time.January, 1, 19, 22, 0, 0, time.UTC),
			...
			29: timetable.Stop{
				...
				Departure: time.Date(0, time.January, 1, 19, 50, 0, 0, time.UTC),
			},
			30: timetable.Stop{
				Id:        30,
				Arrival:   time.Date(0, time.January, 1, 20, 3, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 1, 20, 4, 0, 0, time.UTC),
			},
			31: timetable.Stop{
				Id:        31,
				Arrival:   time.Date(0, time.January, 1, 20, 15, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 1, 20, 16, 0, 0, time.UTC),
			},
			32: timetable.Stop{
				Id:        32,
			...
			34: timetable.Stop{
				Id:        34,
				Arrival:   time.Date(0, time.January, 1, 20, 32, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 1, 20, 33, 0, 0, time.UTC),
			},
			35: timetable.Stop{
				Id:        35,
			...
			40: timetable.Stop{
				Id:        40,
				Arrival:   time.Date(0, time.January, 1, 21, 10, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 1, 21, 11, 0, 0, time.UTC),
			},
			41: timetable.Stop{
				Id:        41,
				Arrival:   time.Date(0, time.January, 1, 21, 14, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 1, 21, 15, 0, 0, time.UTC),
			},
			42: timetable.Stop{
				Id:        42,
				Arrival:   time.Date(0, time.January, 1, 21, 19, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 1, 21, 20, 0, 0, time.UTC),
			},
			43: timetable.Stop{
				Id:        43,
			...
			45: timetable.Stop{
				Id:        45,
				Arrival:   time.Date(0, time.January, 1, 21, 32, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 1, 21, 33, 0, 0, time.UTC),
			},
		},
		6105: timetable.StationIdToStationMap{
			1: timetable.Stop{
				Id:        1,
				Arrival:   time.Date(0, time.January, 1, 23, 26, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 1, 23, 26, 0, 0, time.UTC),
			},
			2: timetable.Stop{
				Id:        2,
				Arrival:   time.Date(0, time.January, 1, 23, 11, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 1, 23, 12, 0, 0, time.UTC),
			},
			3: timetable.Stop{
				Id:        3,
			...
			5: timetable.Stop{
				Id:        5,
				Arrival:   time.Date(0, time.January, 1, 20, 41, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 1, 20, 46, 0, 0, time.UTC),
			},
			6: timetable.Stop{
				Id:        6,
			...
			7: timetable.Stop{
				Id:        7,
				Arrival:   time.Date(0, time.January, 1, 19, 49, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 1, 19, 49, 0, 0, time.UTC),
			},
			20: timetable.Stop{
				Id:        20,
				Arrival:   time.Date(0, time.January, 1, 23, 22, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 1, 23, 23, 0, 0, time.UTC),
			},
			21: timetable.Stop{
				Id:        21,
				Arrival:   time.Date(0, time.January, 1, 23, 3, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 1, 23, 4, 0, 0, time.UTC),
			},
			22: timetable.Stop{
				Id:        22,
				Arrival:   time.Date(0, time.January, 1, 22, 58, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 1, 22, 59, 0, 0, time.UTC),
			},
			23: timetable.Stop{
				Id:        23,
			...
			24: timetable.Stop{
				...
				Departure: time.Date(0, time.January, 1, 22, 49, 0, 0, time.UTC),
			},
			25: timetable.Stop{
				Id:        25,
			...
			28: timetable.Stop{
				Id:        28,
				Arrival:   time.Date(0, time.January, 1, 22, 3, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 1, 22, 4, 0, 0, time.UTC),
			},
			29: timetable.Stop{
				Id:        29,
				Arrival:   time.Date(0, time.January, 1, 21, 40, 0, 0, time.UTC),
			...
			32: timetable.Stop{
				Id:        32,
				Arrival:   time.Date(0, time.January, 1, 21, 6, 0, 0, time.UTC),
			...
			35: timetable.Stop{
				Id:        35,
				Arrival:   time.Date(0, time.January, 1, 20, 53, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 1, 20, 54, 0, 0, time.UTC),
			},
			36: timetable.Stop{
				Id:        36,
				Arrival:   time.Date(0, time.January, 1, 20, 49, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 1, 20, 50, 0, 0, time.UTC),
			},
			37: timetable.Stop{
				Id:        37,
			...
			38: timetable.Stop{
				Id:        38,
				Arrival:   time.Date(0, time.January, 1, 20, 31, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 1, 20, 32, 0, 0, time.UTC),
			},
			39: timetable.Stop{
				Id:        39,
			...
			41: timetable.Stop{
				Id:        41,
				Arrival:   time.Date(0, time.January, 1, 20, 11, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 1, 20, 12, 0, 0, time.UTC),
			},
			42: timetable.Stop{
				Id:        42,
			...
			44: timetable.Stop{
				Id:        44,
				Arrival:   time.Date(0, time.January, 1, 19, 58, 0, 0, time.UTC),
				Departure: time.Date(0, time.January, 1, 19, 59, 0, 0, time.UTC),
			},
			45: timetable.Stop{
				Id:        45,
