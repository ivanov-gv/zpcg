...
func (_m *MockCustomTgClient) RequestWithContext(ctx context.Context, token string, method string, params map[string]string, data map[string]gotgbot.FileReader, opts *gotgbot.RequestOpts) (json.RawMessage, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string, map[string]string, map[string]gotgbot.FileReader, *gotgbot.RequestOpts) (json.RawMessage, error)); ok {
		return rf(ctx, token, method, params, data, opts)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string, map[string]string, map[string]gotgbot.FileReader, *gotgbot.RequestOpts) json.RawMessage); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, string, string, map[string]string, map[string]gotgbot.FileReader, *gotgbot.RequestOpts) error); ok {
...
func (_c *MockCustomTgClient_RequestWithContext_Call) Run(run func(ctx context.Context, token string, method string, params map[string]string, data map[string]gotgbot.FileReader, opts *gotgbot.RequestOpts)) *MockCustomTgClient_RequestWithContext_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(string), args[3].(map[string]string), args[4].(map[string]gotgbot.FileReader), args[5].(*gotgbot.RequestOpts))
	})
	return _c
}
...
func (_c *MockCustomTgClient_RequestWithContext_Call) RunAndReturn(run func(context.Context, string, string, map[string]string, map[string]gotgbot.FileReader, *gotgbot.RequestOpts) (json.RawMessage, error)) *MockCustomTgClient_RequestWithContext_Call {
	_c.Call.Return(run)
	return _c
}
